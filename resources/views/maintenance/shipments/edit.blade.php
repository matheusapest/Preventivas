    ...
    <div class="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">
                        Corrija os dados logísticos do envio do equipamento.
                    </p>
                </div>
        ...
        <x-cards.card class="mb-5 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-200 px-4 py-3.5 sm:px-6 sm:py-4">
                ...
                <p class="mt-0.5 text-xs text-slate-500 sm:text-sm">
                    Consulte os dados do ciclo antes de realizar a correção.
                </p>
            ...
            <div class="grid grid-cols-1 gap-4 p-4 sm:grid-cols-3 sm:p-6">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm font-semibold text-slate-800">
                        {{ $maintenanceShipment->maintenanceOrder?->equipment?->name ?? 'Não informado' }}
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm font-semibold text-slate-800">
                        {{ $maintenanceShipment->company?->name ?? 'Não informado' }}
                    </p>
                </div>
        ...
        <x-cards.card class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-200 px-4 py-3.5 sm:px-6 sm:py-4">
                ...
                <p class="mt-0.5 text-xs text-slate-500 sm:text-sm">
                    Apenas a filial de origem e a nota fiscal podem ser alteradas.
                </p>
            ...
            <form
                method="POST"
                action="{{ route(
                    'reparos_externos.envios.editar.update',
                    $maintenanceShipment
                ) }}"
                class="p-4 sm:p-6"
            >
                ...
                @include(
                    ...
                    [
                        'branches' => $branches,
                        'branchName' => 'origin_branch_id',
                        'branchLabel' => 'Filial de Origem',
                        'selectedBranchId' => $maintenanceShipment->origin_branch_id,
                        'invoiceLabel' => 'Nota Fiscal de Envio',
                        'invoiceNumber' => $maintenanceShipment->invoice_number,
                    ]
                )
